...
$${#eq-linearreg}
@eq-linearreg is our **linear regression model**, and the word "linear" here emphasizes the simplifying assumption that the function is a linear combination of the covariates. Since we want our predictions to minimize the MSE function, the best linear predictor is given by solving
