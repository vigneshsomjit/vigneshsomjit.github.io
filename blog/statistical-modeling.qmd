...
The presence of such randomness makes it challenging to learn about the unobserved characteristics of the DGP using the observed data. **Statistical inference** is the process of (i) using observed data to make *informed predictions* about  unobserved features of the DGP and (ii) using probability to *quantify* the uncertainty in those predictions. [^2] 
